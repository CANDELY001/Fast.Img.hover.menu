...
},{}],"img/demo4/1.jpg":[function(require,module,exports) {
module.exports = "/1.376b664e.jpg";
},{}],"img/demo4/10.jpg":[function(require,module,exports) {
module.exports = "/10.821b07c9.jpg";
},{}],"img/demo4/11.jpg":[function(require,module,exports) {
module.exports = "/11.1201dde3.jpg";
},{}],"img/demo4/12.jpg":[function(require,module,exports) {
module.exports = "/12.0aa60765.jpg";
},{}],"img/demo4/13.jpg":[function(require,module,exports) {
module.exports = "/13.8f6cb021.jpg";
},{}],"img/demo4/14.jpg":[function(require,module,exports) {
module.exports = "/14.4893af22.jpg";
},{}],"img/demo4/15.jpg":[function(require,module,exports) {
module.exports = "/15.4aca273e.jpg";
},{}],"img/demo4/16.jpg":[function(require,module,exports) {
module.exports = "/16.bfa6457c.jpg";
},{}],"img/demo4/17.jpg":[function(require,module,exports) {
module.exports = "/17.9b83f4dd.jpg";
},{}],"img/demo4/18.jpg":[function(require,module,exports) {
module.exports = "/18.a47fa7a9.jpg";
},{}],"img/demo4/19.jpg":[function(require,module,exports) {
module.exports = "/19.d34b3515.jpg";
},{}],"img/demo4/2.jpg":[function(require,module,exports) {
module.exports = "/2.c8c223d9.jpg";
},{}],"img/demo4/20.jpg":[function(require,module,exports) {
module.exports = "/20.aa242cb6.jpg";
},{}],"img/demo4/3.jpg":[function(require,module,exports) {
module.exports = "/3.4b150b5c.jpg";
},{}],"img/demo4/4.jpg":[function(require,module,exports) {
module.exports = "/4.206ad742.jpg";
},{}],"img/demo4/5.jpg":[function(require,module,exports) {
module.exports = "/5.72557cf0.jpg";
},{}],"img/demo4/6.jpg":[function(require,module,exports) {
module.exports = "/6.dae49e4f.jpg";
},{}],"img/demo4/7.jpg":[function(require,module,exports) {
module.exports = "/7.92c49dce.jpg";
},{}],"img/demo4/8.jpg":[function(require,module,exports) {
module.exports = "/8.029c7dba.jpg";
},{}],"img/demo4/9.jpg":[function(require,module,exports) {
module.exports = "/9.c1ab683f.jpg";
},{}],"img/demo4/*.jpg":[function(require,module,exports) {
module.exports = {
  "1": require("./1.jpg"),
  "2": require("./2.jpg"),
  "3": require("./3.jpg"),
...
},{"./1.jpg":"img/demo4/1.jpg","./10.jpg":"img/demo4/10.jpg","./11.jpg":"img/demo4/11.jpg","./12.jpg":"img/demo4/12.jpg","./13.jpg":"img/demo4/13.jpg","./14.jpg":"img/demo4/14.jpg","./15.jpg":"img/demo4/15.jpg","./16.jpg":"img/demo4/16.jpg","./17.jpg":"img/demo4/17.jpg","./18.jpg":"img/demo4/18.jpg","./19.jpg":"img/demo4/19.jpg","./2.jpg":"img/demo4/2.jpg","./20.jpg":"img/demo4/20.jpg","./3.jpg":"img/demo4/3.jpg","./4.jpg":"img/demo4/4.jpg","./5.jpg":"img/demo4/5.jpg","./6.jpg":"img/demo4/6.jpg","./7.jpg":"img/demo4/7.jpg","./8.jpg":"img/demo4/8.jpg","./9.jpg":"img/demo4/9.jpg"}],"js/demo4/menuItem.js":[function(require,module,exports) {
"use strict";
...
function _toPropertyKey(arg) { var key = _toPrimitive(arg, "string"); return _typeof(key) === "symbol" ? key : String(key); }
function _toPrimitive(input, hint) { if (_typeof(input) !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (_typeof(res) !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); }
var images = Object.entries(require('../../img/demo4/*.jpg'));
  ...
  _createClass(MenuItem, [{
    ...
    value: function layout() {
      ...
      for (var i = 0; i <= this.totalImages - 1; ++i) {
        inner += i === this.totalImages - 1 ? "<div class=\"hover-reveal__img\" style=\"position: absolute; background-image:url(".concat(images[this.inMenuPosition][1], ")\"></div>") : "<div class=\"hover-reveal__img\" style=\"filter: hue-rotate(".concat((0, _utils.getRandomFloat)(10, 90), "deg) saturate(").concat((0, _utils.getRandomFloat)(2, 10), "); position: absolute; background-image:url(").concat(images[this.inMenuPosition][1], ")\"></div>");
      }
    ...
    value: function showImage() {
      ...
      _gsap.gsap.killTweensOf(this.DOM.revealImgs);
      ...
      for (var i = 0; i <= this.totalImages - 1; ++i) {
        _gsap.gsap.set(this.DOM.revealImgs[i], {
          x: i === this.totalImages - 1 ? '0%' : "".concat((0, _utils.getRandomFloat)(-40, 40), "%"),
          y: i === this.totalImages - 1 ? '0%' : "".concat((0, _utils.getRandomFloat)(-40, 40), "%"),
          rotation: "".concat(i === this.totalImages - 1 ? 0 : (0, _utils.getRandomFloat)(-10, 10))
        });
    ...
    value: function render() {
      ...
      // new scale value
      this.animatableProperties.scale.current = this.firstRAFCycle ? 1 : (0, _utils.map)(mouseDistanceX, 0, 80, 1, 5);
      // new filter value
      this.animatableProperties.saturate.current = this.firstRAFCycle ? 1 : (0, _utils.map)(mouseDistanceX, 0, 10, 1, 0);
      ...
      this.animatableProperties.scale.previous = this.firstRAFCycle ? this.animatableProperties.scale.current : (0, _utils.lerp)(this.animatableProperties.scale.previous, this.animatableProperties.scale.current, this.animatableProperties.scale.amt);
      this.animatableProperties.saturate.previous = this.firstRAFCycle ? this.animatableProperties.saturate.current : (0, _utils.lerp)(this.animatableProperties.saturate.previous, this.animatableProperties.saturate.current, this.animatableProperties.saturate.amt);
      ...
      _gsap.gsap.set(this.DOM.reveal, {
        ...
        filter: "saturate(".concat(this.animatableProperties.saturate.previous, ")")
      });
      _gsap.gsap.set(this.DOM.revealImgs, {
        scaleX: this.animatableProperties.scale.previous,
        scaleY: (0, _utils.map)(this.animatableProperties.scale.previous, 1, 5, 1, 0.1)
      });
...
},{"gsap":"../node_modules/gsap/index.js","../utils":"js/utils.js","../../img/demo4/*.jpg":"img/demo4/*.jpg"}],"js/demo4/menu.js":[function(require,module,exports) {
"use strict";
...
},{"gsap":"../node_modules/gsap/index.js","./menuItem":"js/demo4/menuItem.js"}],"js/demo4/index.js":[function(require,module,exports) {
"use strict";
...
},{"../cursor":"js/cursor.js","../preloader":"js/preloader.js","locomotive-scroll":"../node_modules/locomotive-scroll/dist/locomotive-scroll.esm.js","./menu":"js/demo4/menu.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
