...
},{"./1.jpg":"img/demo1/1.jpg","./10.jpg":"img/demo1/10.jpg","./11.jpg":"img/demo1/11.jpg","./12.jpg":"img/demo1/12.jpg","./14.jpg":"img/demo1/14.jpg","./16.jpg":"img/demo1/16.jpg","./15.jpg":"img/demo1/15.jpg","./17.jpg":"img/demo1/17.jpg","./18.jpg":"img/demo1/18.jpg","./13.jpg":"img/demo1/13.jpg","./19.jpg":"img/demo1/19.jpg","./2.jpg":"img/demo1/2.jpg","./3.jpg":"img/demo1/3.jpg","./20.jpg":"img/demo1/20.jpg","./4.jpg":"img/demo1/4.jpg","./5.jpg":"img/demo1/5.jpg","./6.jpg":"img/demo1/6.jpg","./7.jpg":"img/demo1/7.jpg","./8.jpg":"img/demo1/8.jpg","./9.jpg":"img/demo1/9.jpg"}],"js/demo1/menuItem.js":[function(require,module,exports) {
"use strict";
...
function _toPropertyKey(arg) { var key = _toPrimitive(arg, "string"); return _typeof(key) === "symbol" ? key : String(key); }
function _toPrimitive(input, hint) { if (_typeof(input) !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (_typeof(res) !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); }
var images = Object.entries(require('../../img/demo1/*.jpg'));
  ...
  _createClass(MenuItem, [{
    ...
    value: function initEvents() {
      ...
      this.mouseenterFn = function (ev) {
        ...
        _this.DOM.reveal.style.transformOrigin = "0% ".concat(_this.mouseArea === 'up' ? 0 : 100, "%");
    ...
    value: function render() {
      ...
      // new rotation value
      this.animatableProperties.rotation.current = this.firstRAFCycle ? 0 : (0, _utils.map)(mouseDistanceX, 0, 175, 0, direction.x < 0 ? this.mouseArea === 'up' ? 60 : -60 : this.mouseArea === 'up' ? -60 : 60);
      // new filter value
      this.animatableProperties.brightness.current = this.firstRAFCycle ? 1 : (0, _utils.map)(mouseDistanceX, 0, 100, 1, 8);
